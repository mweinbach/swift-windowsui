...
1. Read the assigned feature, the validation assertions it fulfills, `.factory/library/architecture.md`, `.factory/library/user-testing.md`, and `.factory/services.yaml`.
