...
- List source checkpoint: flat data and builder-authored `ForEach` rows now defer construction and join keyed state, physical task lifetime, scrolling, selection, and logical UIA ownership. Combined compilation and execution remain pending. [Deferred List construction](docs/DeferredListConstruction.md) and [List keyboard navigation](docs/ListKeyboardNavigation.md) document the implemented source and remaining requirements
