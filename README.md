...
- Text entry includes click/caret-aware single-line fields, keyboard selection replacement/deletion, and a basic multiline `TextEditor`, but drag selection and rich editing are still future work
