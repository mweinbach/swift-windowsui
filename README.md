...
- Text fitting: `minimumScaleFactor(_:)` reduces the retained effective text size before truncation when constrained width requires it, across DirectWrite, GDI, pixel fallback, and the GPUI scene glyph path
