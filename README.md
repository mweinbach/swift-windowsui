...
- Containers: `VStack`, `HStack`, `ZStack`, `ScrollView`, `List` including data-driven row initializers, `Form`, `Section` including header/footer builder overloads, `GroupBox`, `DisclosureGroup`, `HSplitView`, `VSplitView`; stack spacing accepts SwiftUI-style `nil`
