...
- Controls: `Button` with role, `systemImage`, and common style variants, `TextField`, `SecureField`, `Toggle`, `Slider`, labeled `ProgressView`, `Picker` with hashable selection tags
