...
let dwriteFontStretchExtraCondensed: DWriteFontStretch = 2
let dwriteFontStretchCondensed: DWriteFontStretch = 3
let dwriteFontStretchNormal: DWriteFontStretch = 5
let dwriteFontStretchExpanded: DWriteFontStretch = 7
