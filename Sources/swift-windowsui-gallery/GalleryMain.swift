...
struct SwiftWindowsUIGalleryTool {
    ...
    static func main() throws {
        ...
        let gallerySpecs: [GallerySpec] = [
            ...
            GallerySpec(id: "vstack", title: "VStack", view: AnyView(
                VStack(spacing: 8) {
            ...
            GallerySpec(id: "zstack", title: "ZStack", view: AnyView(
                ZStack {
            ...
            GallerySpec(id: "button", title: "Button", view: AnyView(
                Button("Tap Me") {}
                    .frame(width: 100, height: 40)
            )),
            GallerySpec(id: "toggle", title: "Toggle", view: AnyView(
                Toggle("Enabled", isOn: .constant(true))
                    .frame(width: 140, height: 40)
            )),
            GallerySpec(id: "slider", title: "Slider", view: AnyView(
                Slider(value: .constant(0.5))
                    .frame(width: 160, height: 40)
            )),
            GallerySpec(id: "picker", title: "Picker", view: AnyView(
            ...
            GallerySpec(id: "text-field", title: "TextField", view: AnyView(
                TextField("Placeholder", text: .constant("Hello"))
                    .frame(width: 160, height: 40)
                    .padding(8)
            )),
            GallerySpec(id: "list", title: "List", view: AnyView(
                List {
                    Text("Item 1")
                    Text("Item 2")
                    Text("Item 3")
            ...
            GallerySpec(id: "form", title: "Form", view: AnyView(
                Form {
            ...
            GallerySpec(id: "navigation-stack", title: "NavigationStack", view: AnyView(
                NavigationStack {
                    Text("Root View")
            ...
            GallerySpec(id: "aspect-ratio", title: "Aspect Ratio", view: AnyView(
                Rectangle()
                    .fill(.red)
                    .aspectRatio(2.0, contentMode: .fit)
                    .frame(width: 160, height: 100)
            )),
            GallerySpec(id: "mask", title: "Mask", view: AnyView(
                Rectangle()
                    .fill(.blue)
            ...
            GallerySpec(id: "overlay", title: "Overlay", view: AnyView(
                Rectangle()
                    .fill(.green)
                    .frame(width: 100, height: 100)
                    .overlay(
            ...
            GallerySpec(id: "background-alignment", title: "Background + Alignment", view: AnyView(
                Text("A")
            ...
            GallerySpec(id: "matched-geometry", title: "MatchedGeometryEffect", view: AnyView(
                HStack(spacing: 20) {
                    Rectangle()
                        .fill(.blue)
            ...
            GallerySpec(id: "progress-view", title: "ProgressView", view: AnyView(
                ProgressView(value: 0.6)
                    .frame(width: 120, height: 40)
            )),
            GallerySpec(id: "stepper", title: "Stepper", view: AnyView(
                Stepper(value: .constant(5), in: 0...10) {
                    Text("Count: 5")
                }
                .frame(width: 140, height: 40)
            )),
            GallerySpec(id: "menu", title: "Menu", view: AnyView(
                Menu("Options") {
                    Button("Option 1") {}
                    Button("Option 2") {}
                }
            ...
            GallerySpec(id: "link", title: "Link", view: AnyView(
                Link("Open", destination: URL(string: "https://example.com")!)
                    .frame(width: 100, height: 40)
            )),
            GallerySpec(id: "divider", title: "Divider", view: AnyView(
                VStack {
                    Text("Above")
                    Divider()
                    Text("Below")
            ...
            GallerySpec(id: "spacer", title: "Spacer", view: AnyView(
                HStack {
            ...
            GallerySpec(id: "geometry-reader", title: "GeometryReader", view: AnyView(
            ...
            GallerySpec(id: "scroll-view", title: "ScrollView", view: AnyView(
                ScrollView {
                    VStack(spacing: 8) {
                        ForEach(0..<5) { i in
                            Rectangle()
            ...
            GallerySpec(id: "for-each", title: "ForEach", view: AnyView(
                VStack(spacing: 4) {
                    ForEach(0..<4) { i in
                        Rectangle()
            ...
            GallerySpec(id: "if-else", title: "Conditional View", view: AnyView(
                VStack(spacing: 8) {
                    if true {
            ...
            GallerySpec(id: "group", title: "Group", view: AnyView(
                Group {
            ...
            GallerySpec(id: "transition", title: "Transition", view: AnyView(
                Text("Hello")
                    .transition(.opacity)
                    .frame(width: 80, height: 40)
            )),
            GallerySpec(id: "animation", title: "Animation", view: AnyView(
                Rectangle()
                    .fill(.red)
