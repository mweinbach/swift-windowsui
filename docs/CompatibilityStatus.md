...
| `MultiDatePicker` | **Partial** | Retained month browsing and multi-selection with inherited calendar settings, mounted browse state, and retained day/navigation buttons. The new 32-case source slice awaits execution; ranges, native calendar focus, API availability, and visual parity remain unqualified ([details](MultiDatePicker.md)) |
