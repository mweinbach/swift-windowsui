...
- `ControlGroup` maps to compact retained horizontal group chrome, accepts title, system-image label, and builder-label forms, and preserves nested control actions while applying borderless button style to grouped buttons.
