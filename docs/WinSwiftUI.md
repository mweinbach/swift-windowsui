...
- `EdgeInsets()`
- minimal `Binding`, `State`, `Environment`, `EnvironmentValues`, `OpenURLAction`, `DismissAction`, `RefreshAction`, `EditMode`, `ObservableObject`, `Published`, `ObservedObject`, and `StateObject`
