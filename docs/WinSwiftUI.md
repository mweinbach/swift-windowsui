...
- `controlSize(_:)` propagates through `ViewBuildContext` and maps to retained preferred sizes for text inputs, toggle, menu picker, stepper buttons, slider, and progress bar surfaces.
